...
class ApiRunCacheTests(unittest.TestCase):
    ...
    def test_health_payload_can_prewarm_generation_runtime(self) -> None:
        ...
        self.assertEqual(cold["ocr"]["provider_ui_rapidocr_max_dimension"], 1200)
        self.assertEqual(cold["ocr"]["provider_ui_rapidocr_detector_limit_side_len"], 256)
        ...
        self.assertEqual(cold["ocr"]["rapidocr_warm_detector_limits"], [608, 256])
