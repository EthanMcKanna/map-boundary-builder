...
class ApiRunCacheTests(unittest.TestCase):
    ...
    def test_health_payload_can_prewarm_generation_runtime(self) -> None:
        ...
        self.assertEqual(cold["ocr"]["rapidocr_svg_bright_blue_warm_sample_max_dimension"], 1000)
        ...
        self.assertEqual(cold["ocr"]["rapidocr_bright_blue_warm_sample_max_dimension"], 1000)
        self.assertEqual(
        ...
        self.assertFalse(cold["ocr"]["onnxruntime_allow_spinning"])
