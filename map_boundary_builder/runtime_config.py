...
GENERATION_ENV_DEFAULTS = {
    ...
    "MAP_BOUNDARY_GRAY_FILL_ROUTE_UI_OCR_MAX_DIMENSION": "900",
    ...
    "MAP_BOUNDARY_SVG_PROVIDER_UI_CROP_OCR_MAX_DIMENSION": "625",
...
SVG_PROVIDER_UI_CROP_OCR_MAX_DIMENSION = env_int(
...
def ocr_runtime_config() -> dict[str, Any]:
    return {
        ...
        "svg_provider_ui_crop_ocr_max_dimension": SVG_PROVIDER_UI_CROP_OCR_MAX_DIMENSION,
